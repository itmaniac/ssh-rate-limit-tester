# Filename: ssh-rate-limit-tester.py Compiled by Emran Kamal (@ITManiac)
...
# Use only on systems you own or are legally authorized to test, and comply with all applicable laws.
# The author bears no liability for misuse or damages. Use with caution.
# --- END DISCLAIMER ---
...
def main():
    ...
    # Print the disclaimer right at the start of execution
    print("\n" + "="*70)
    print("                 SSH Rate Limit Tester Disclaimer")
    print("="*70)
    print("This script is provided for EDUCATIONAL and LEGAL VAPT PURPOSES ONLY.")
    print("You must have EXPLICIT WRITTEN PERMISSION from the system owner before using this tool.")
    print("Comply with all applicable local, national, and international laws.")
    print("The author bears no liability for any misuse or damages caused by this script.")
    print("By proceeding, you acknowledge and agree to these terms.")
    print("="*70 + "\n")
